...
static VALUE arguments_inspect(SnFunction* function, SnCallFrame* here, VALUE self, VALUE it) {
...
static VALUE arguments_splat(SnFunction* function, SnCallFrame* here, VALUE self, VALUE it) {
	return self;
}
