...
CAPI VALUE snow_call(VALUE function, VALUE self, struct SnArguments*);
CAPI struct SnFunction* snow_get_method(VALUE self, SnSymbol member);
CAPI VALUE snow_call_method(VALUE self, struct SnFunction* method, struct SnArguments*);
CAPI VALUE snow_call_method_va(VALUE self, SnSymbol member, size_t num_args, ...);
