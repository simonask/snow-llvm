...
static VALUE io_file_initialize(SnFunction* function, SnCallFrame* here, VALUE self, VALUE it) {
...
static VALUE io_file_read(SnFunction* function, SnCallFrame* here, VALUE self, VALUE it) {
...
static VALUE io_file_gets(SnFunction* function, SnCallFrame* here, VALUE self, VALUE it) {
	SnPointer* _fp = snow_get_member(self, snow_sym("_fp"));
	ASSERT(snow_type_of(_fp) == SnPointerType);
	FILE* fp = (FILE*)_fp->ptr;
...
static VALUE io_file_write(SnFunction* function, SnCallFrame* here, VALUE self, VALUE it) {
	SnPointer* _fp = snow_get_member(self, snow_sym("_fp"));
	ASSERT(snow_type_of(_fp) == SnPointerType);
	FILE* fp = (FILE*)_fp->ptr;
...
static VALUE io_file_seek(SnFunction* function, SnCallFrame* here, VALUE self, VALUE it) {
	SnPointer* _fp = snow_get_member(self, snow_sym("_fp"));
	ASSERT(snow_type_of(_fp) == SnPointerType);
	FILE* fp = (FILE*)_fp->ptr;
...
static VALUE io_file_tell(SnFunction* function, SnCallFrame* here, VALUE self, VALUE it) {
	SnPointer* _fp = snow_get_member(self, snow_sym("_fp"));
	ASSERT(snow_type_of(_fp) == SnPointerType);
	FILE* fp = (FILE*)_fp->ptr;
...
static VALUE io_file_puts(SnFunction* function, SnCallFrame* here, VALUE self, VALUE it) {
	SnPointer* _fp = snow_get_member(self, snow_sym("_fp"));
	ASSERT(snow_type_of(_fp) == SnPointerType);
	FILE* fp = (FILE*)_fp->ptr;
...
static VALUE io_file_close(SnFunction* function, SnCallFrame* here, VALUE self, VALUE it) {
	SnPointer* _fp = snow_get_member(self, snow_sym("_fp"));
	ASSERT(snow_type_of(_fp) == SnPointerType);
	FILE* fp = (FILE*)_fp->ptr;
...
static VALUE io_file_eof(SnFunction* function, SnCallFrame* here, VALUE self, VALUE it) {
	SnPointer* _fp = snow_get_member(self, snow_sym("_fp"));
	ASSERT(snow_type_of(_fp) == SnPointerType);
	FILE* fp = (FILE*)_fp->ptr;
...
static VALUE io_file_size(SnFunction* function, SnCallFrame* here, VALUE self, VALUE it) {
	SnPointer* _fp = snow_get_member(self, snow_sym("_fp"));
	ASSERT(snow_type_of(_fp) == SnPointerType);
	FILE* fp = (FILE*)_fp->ptr;
	int fd = fileno(fp);
...
static VALUE io_file_each_line(SnFunction* function, SnCallFrame* here, VALUE self, VALUE it) {
	SnPointer* _fp = snow_get_member(self, snow_sym("_fp"));
	ASSERT(snow_type_of(_fp) == SnPointerType);
	FILE* fp = (FILE*)_fp->ptr;
